requirejs([
    ...
    class PlayGame {
        static chance = PlayGame.randomNumberFromRange(40, 49.5);
        static stop = false;
        ...
        static chanceGo = {min: 5, max: 20};
        static listGameGo = [];
        static target = 50;
        static startBalance = null;
        constructor(){
            this.createChange();
            this.createTool();
        ...
        createTool = () => {
            ...
            var headNameBot = $('<h1/>', {text: 'Super Bot Dice', style: 'color: white;'}).append('<br/>').append($('<small/>', {text: 'Chance 40 - 49.5 v2.0', style: 'color: white;'}));
            ...
            $('.dice__stats').height(560);
            $('.dice__stats__content').height(480);
        };
        ...
        static getGoChange(){
            ...
            PlayGame.listGameGo.forEach(function (item) {
                ['hi', 'low'].forEach(function (condition) {
                    if (item[condition].tilethang >= 30 && item[condition].tilethang <= 35 && item[condition].tilethang >= phantram){
        ...
        static updateChance = ()=>{
            ...
            if(go && go.tilethang >= 30 && go.tilethang <= 35 && PlayGame.balanceLose > 0){
