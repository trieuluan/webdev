...
var GameCondition = {
    ...
    createTool: function () {
        ...
        var block4 = $('<div/>', {class: 'row__game__options__block border__right', style: 'flex: 0 0 100%;'}).append('<div class="title">How many roll you want to get price back (Recommend 50 - 100)</div>');
        ...
        fatherOptions.append(block1).append(block2).append(block3).append(block4);
